    ...
    public function run(): void
    {
        $plans = [
            [
                ...
                'price_stripe_id' => 'price_dirt_free',
                'server_limit' => 1,
                'disk' => 5120, // 5 Go
            ],
            [
                ...
                'price_stripe_id' => 'price_stone_490',
                'server_limit' => 1,
                'disk' => 10240, // 10 Go
            ],
            [
                ...
                'price_stripe_id' => 'price_iron_990',
                'server_limit' => 2,
                'disk' => 20480, // 20 Go
            ],
            [
                ...
                'price_stripe_id' => 'price_diamond_1990',
                'server_limit' => 5,
                'disk' => 35840, // 35 Go
            ],
            [
                ...
                'price_stripe_id' => 'price_netherite_3990',
                'server_limit' => 10,
                'disk' => 51200, // 50 Go
            ],
        ];

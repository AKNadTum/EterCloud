        ...
        <x-ui.card title="Modifier le Plan" description="Configurez les ressources et les limites du plan {{ $plan->name }}." class="max-w-4xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    <x-ui.forms.group label="Nom du Plan" name="name" required>
                        <x-ui.input type="text" name="name" id="name" value="{{ old('name', $plan->name) }}" required :invalid="$errors->has('name')" />
                    </x-ui.forms.group>
                </div>

                <div class="md:col-span-2">
                    <x-ui.forms.group label="Description" name="description">
                ...
                <div>
                    <x-ui.forms.group label="Stripe Price ID" name="price_stripe_id" required description="{{ $stripeDetails ? 'Prix actuel sur Stripe : ' . $stripeDetails['price'] . ' / ' . $stripeDetails['period'] : null }}">
                ...
                <div>
                    <x-ui.forms.group label="Limite de Serveurs" name="server_limit" required>
                ...
                <div>
                    <x-ui.forms.group label="Limite Backups" name="backups_limit" required>
                ...
                <div class="md:col-span-2 border-t border-[var(--border)] pt-4">
                    <x-ui.forms.group label="Localisations autorisées" name="locations">

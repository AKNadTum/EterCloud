    ...
    <form action="{{ route('admin.plans.update', $plan) }}" method="POST">
        ...
        <x-ui.card title="Modifier le Plan" description="Configurez les ressources et les limites du plan {{ $plan->name }}." class="max-w-4xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <x-ui.input label="Stripe Price ID" name="price_stripe_id" required description="{{ $stripeDetails ? 'Prix actuel sur Stripe : ' . $stripeDetails['price'] . ' / ' . $stripeDetails['period'] : null }}">
                ...
                <div>
                    <x-ui.input label="Limite de Serveurs" name="server_limit" required>
                ...
                <div>
                    <x-ui.input label="Limite Backups" name="backups_limit" required>
                ...
                <div class="md:col-span-2 border-t border-[var(--border)] pt-4">
                    <x-ui.input label="Localisations autorisées" name="locations">

        ...
        <form action="{{ route('admin.permissions.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <x-ui.input type="text" name="name" id="name" value="{{ old('name') }}" required :invalid="$errors->has('name')" placeholder="Ex: Supprimer un serveur" />
                ...
                <div>
                    ...
                    <x-ui.input type="text" name="slug" id="slug" value="{{ old('slug') }}" required :invalid="$errors->has('slug')" placeholder="Ex: server.delete" />
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-[var(--border)]">
                    ...
                    <x-ui.button type="submit">Créer la Permission</x-ui.button>
                </div>
            </div>
        </form>
    </div>

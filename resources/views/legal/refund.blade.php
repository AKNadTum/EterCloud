...
<div class="py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-slate max-w-none">
            ...
            <section class="mb-8">
                <h2 class="text-2xl font-semibold mb-4 text-[var(--primary-foreground)]">2. Conditions de remboursement Eternom</h2>
                <p>Chez Eternom, nous offrons une garantie "Satisfait ou Remboursé" de <strong>72 heures</strong>. Si vous n'êtes pas satisfait de nos services dans les 3 premiers jours suivant votre premier achat, vous pouvez demander un remboursement intégral, sans justification.</p>
            ...
            <section class="mb-8">
                ...
                <p>Pour demander un remboursement, vous devez ouvrir un ticket de support via votre tableau de bord ou envoyer un email à <a href="mailto:support@eternom.fr" class="text-[var(--primary-foreground)] hover:underline font-medium">support@eternom.fr</a> avec vos informations de commande.</p>
            ...
            <section class="mb-8">
                ...
                <p>Dans certains cas, nous pouvons proposer un remboursement sous forme de crédits ajoutés à votre compte Eternom pour une utilisation future. Ces crédits ne sont pas remboursables en argent réel une fois acceptés.</p>
            </section>

            <section class="mb-8">
                <h2 class="text-2xl font-semibold mb-4 text-[var(--primary-foreground)]">5. Modification de la politique</h2>
                <p>Eternom se réserve le droit de modifier cette politique de remboursement à tout moment. Les nouvelles conditions s'appliqueront uniquement aux achats effectués après la date de modification.</p>
            </section>
